...
소니이미지웍스와 ILM이 같이 개발하고 있습니다. Pixar는 USD를 개발하고 있어요.

아래 상황에서 자주 사용합니다. 발췌 : http://www.alembic.io

- 애니메이션 데이터를 베이크하여 라이팅, 렌더링 할 때
- 에니메이션된 크리쳐 데이터에서 옷이나 피부를 시뮬레이션 할 때
...
Ogawa(기본값) 형식만 지원하도록 컴파일 하겠습니다. Ogawa 파일은 HDF5 파일 보다 작을 수 있으며 일반적으로 더 빠르게 로드됩니다. HDF5는 예전에 abc에서 사용하던 방식입니다.
